...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($equipmentModel->serialNumberExists($data['serial_number'], $id)) {
    ...
    if (empty($errors)) {
        if ($equipmentModel->update($id, $data)) {
            ...
            $equipment = $equipmentModel->getById($id); // Reload data
        } else {
...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Edit Equipment</h2>
            <a href="view.php?id=<?php echo $equipment['id']; ?>" class="btn btn-secondary">Back to Details</a>
        </div>
        ...
        <form method="POST" action="">
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="serial_number" name="serial_number" class="form-control" 
                           value="<?php echo htmlspecialchars($equipment['serial_number']); ?>" required>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="category" name="category" class="form-control" 
                           value="<?php echo htmlspecialchars($equipment['category']); ?>" required>
                </div>
                
                <div class="form-group">
                    <label for="department">Department *</label>
                    <input type="text" id="department" name="department" class="form-control" 
                           value="<?php echo htmlspecialchars($equipment['department']); ?>" required>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="assigned_employee" name="assigned_employee" class="form-control" 
                           value="<?php echo htmlspecialchars($equipment['assigned_employee']); ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="physical_location" name="physical_location" class="form-control" 
                           value="<?php echo htmlspecialchars($equipment['physical_location']); ?>">
                </div>
            </div>
                    ...
                    <select id="default_maintenance_team_id" name="default_maintenance_team_id" class="form-control">
                        ...
                        <?php foreach ($teams as $team): ?>
                            <option value="<?php echo $team['id']; ?>" 
                                    <?php echo $equipment['default_maintenance_team_id'] == $team['id'] ? 'selected' : ''; ?>>
            ...
            <div class="flex gap-10">
                ...
                <a href="view.php?id=<?php echo $equipment['id']; ?>" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
